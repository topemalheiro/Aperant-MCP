# Aperant-MCP CLI Usage

This document covers terminal-only usage of Aperant-MCP. **For most users, we recommend using the [Desktop UI](#) instead** - it provides a better experience with visual task management, progress tracking, and automatic Python environment setup.

## When to Use CLI

- You prefer terminal workflows
- You're running on a headless server
- You're integrating Aperant-MCP into scripts or CI/CD
...
Aperant-MCP uses Git worktrees for isolated builds:
