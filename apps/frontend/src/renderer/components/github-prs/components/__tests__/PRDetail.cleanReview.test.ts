...
describe('PRDetail Clean Review Functionality', () => {
  ...
  describe('Clean Review Comment Format', () => {
    it('should format clean review comment correctly', () => {
      ...
      const cleanReviewMessage = `## ✅ Aperant-MCP PR Review - PASSED
...
*This automated review found no issues. Generated by Aperant-MCP.*`;

      expect(cleanReviewMessage).toContain('## ✅ Aperant-MCP PR Review - PASSED');
      expect(cleanReviewMessage).toContain('**Status:** All code is good');
      expect(cleanReviewMessage).toContain(reviewResult.summary);
      expect(cleanReviewMessage).toContain('*This automated review found no issues. Generated by Aperant-MCP.*');
    });
