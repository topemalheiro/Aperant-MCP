...
This directory contains the refactored IPC (Inter-Process Communication) handlers for Aperant-MCP UI, organized into domain-specific modules for better maintainability and code organization.
